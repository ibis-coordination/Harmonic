...
class Notification
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Notification` class because it declared `has_many :notification_recipients`.
    ...
    # This method is created by ActiveRecord on the `Notification` class because it declared `has_many :recipients, through: :notification_recipients`.
