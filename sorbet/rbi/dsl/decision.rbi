...
class Decision
  ...
  module CommonRelationMethods
    ...
    sig { params(limit: NilClass).returns(T.nilable(::Decision)) }
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Decision` class because it declared `has_many :approvals`.
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_options_open?; end
