...
class DecisionParticipant
  ...
  module CommonRelationMethods
    ...
    sig { params(limit: NilClass).returns(T.nilable(::DecisionParticipant)) }
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `DecisionParticipant` class because it declared `has_many :approvals`.
