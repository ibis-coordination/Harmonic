...
class Webhook
  ...
  module CommonRelationMethods
    ...
    sig { params(limit: NilClass).returns(T.nilable(::Webhook)) }
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Webhook` class because it declared `has_many :webhook_deliveries`.
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Webhook, Integer, String, T::Enumerable[T.any(::Webhook, Integer, String, T::Enumerable[::Webhook])])
