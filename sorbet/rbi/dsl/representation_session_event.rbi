...
class RepresentationSessionEvent
  ...
  module CommonRelationMethods
    ...
    sig { params(limit: NilClass).returns(T.nilable(::RepresentationSessionEvent)) }
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_context_resource_type?; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_representation_session_id?; end
