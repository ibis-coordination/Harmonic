...
# This is an autogenerated file for dynamic methods in `Scene`.
# Please instead update this file by running `bin/tapioca dsl Scene`.
...
class Scene
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Scene).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.any(Integer, Float, BigDecimal)) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Scene).void)).returns(::Scene) }
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::Scene).void).returns(Integer) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Scene])
    end
    sig { params(args: NilClass, block: T.proc.params(object: ::Scene).void).returns(T.nilable(::Scene)) }
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::Scene)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Scene) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.proc.params(object: ::Scene).void
      ).void
    end
    sig do
      params(
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::Scene]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Scene]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Scene)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Scene) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::Scene) }
    def find_sole_by(arg, *args); end

    sig { params(limit: NilClass).returns(T.nilable(::Scene)) }
    sig { params(limit: Integer).returns(T::Array[::Scene]) }
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Scene).returns(T.type_parameter(:U))
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Scene, T::Enumerable[T.any(::Scene, T::Enumerable[::Scene])])
    ...
    sig do
      params(
        records: T.any(::Scene, Integer, String, T::Enumerable[T.any(::Scene, Integer, String, T::Enumerable[::Scene])])
      ).returns(T::Array[::Scene])
    end
    ...
    sig do
      params(
        other_array: T.any(::Scene, T::Enumerable[T.any(::Scene, T::Enumerable[::Scene])])
      ).returns(T::Array[::Scene])
    end
