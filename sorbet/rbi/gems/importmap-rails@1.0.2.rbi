...
class Importmap::Map
  ...
  #
  # source://importmap-rails//lib/importmap/map.rb#71
  ...
  #   end
  #
  # source://importmap-rails//lib/importmap/map.rb#64
  ...
  # source://importmap-rails//lib/importmap/map.rb#10
  ...
  # source://importmap-rails//lib/importmap/map.rb#25
  def pin(name, to: T.unsafe(nil), preload: T.unsafe(nil)); end

  # source://importmap-rails//lib/importmap/map.rb#30
  ...
  #
  # source://importmap-rails//lib/importmap/map.rb#39
  ...
  #
  # source://importmap-rails//lib/importmap/map.rb#50
  def to_json(resolver:, cache_key: T.unsafe(nil)); end

  private

  # source://importmap-rails//lib/importmap/map.rb#160
  def absolute_root_of(path); end

  # source://importmap-rails//lib/importmap/map.rb#86
  def cache_as(name); end

  # source://importmap-rails//lib/importmap/map.rb#101
  def clear_cache; end

  # source://importmap-rails//lib/importmap/map.rb#134
  def expand_directories_into(paths); end

  # source://importmap-rails//lib/importmap/map.rb#130
  def expanded_packages_and_directories; end

  # source://importmap-rails//lib/importmap/map.rb#126
  ...
  # source://importmap-rails//lib/importmap/map.rb#148
  def module_name_from(filename, mapping); end

  # source://importmap-rails//lib/importmap/map.rb#152
  def module_path_from(filename, mapping); end

  # source://importmap-rails//lib/importmap/map.rb#95
  def remember_cache_key(name); end

  # @return [Boolean]
  #
  # source://importmap-rails//lib/importmap/map.rb#107
  def rescuable_asset_error?(error); end

  # source://importmap-rails//lib/importmap/map.rb#111
  def resolve_asset_paths(paths, resolver:); end
end

# source://importmap-rails//lib/importmap/map.rb#83
...
# source://importmap-rails//lib/importmap/map.rb#84
