...
class ActionCable::SubscriptionAdapter::PostgreSQL < ::ActionCable::SubscriptionAdapter::Base
  ...
  # source://actioncable//lib/action_cable/subscription_adapter/postgresql.rb#19
  def broadcast(channel, payload); end

  # source://actioncable//lib/action_cable/subscription_adapter/postgresql.rb#33
  def shutdown; end

  # source://actioncable//lib/action_cable/subscription_adapter/postgresql.rb#25
  def subscribe(channel, callback, success_callback = T.unsafe(nil)); end
...
# source://actioncable//lib/action_cable/subscription_adapter/redis.rb#12
class ActionCable::SubscriptionAdapter::Redis < ::ActionCable::SubscriptionAdapter::Base
  include ::ActionCable::SubscriptionAdapter::ChannelPrefix

  # @return [Redis] a new instance of Redis
  #
  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#22
  def initialize(*_arg0); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#28
  def broadcast(channel, payload); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#44
  def redis_connection_for_subscriptions; end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#18
  def redis_connector; end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#18
  def redis_connector=(val); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#40
  def shutdown; end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#32
  def subscribe(channel, callback, success_callback = T.unsafe(nil)); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#36
  def unsubscribe(channel, callback); end

  private

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#63
  def config_options; end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#49
  def listener; end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#59
  def redis_connection; end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#53
...
# source://actioncable//lib/action_cable/subscription_adapter/redis.rb#67
class ActionCable::SubscriptionAdapter::Redis::Listener < ::ActionCable::SubscriptionAdapter::SubscriberMap
  # @return [Listener] a new instance of Listener
  #
  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#68
  def initialize(adapter, config_options, event_loop); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#141
  def add_channel(channel, on_success); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#155
  def invoke_callback(*_arg0); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#89
  def listen(conn); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#149
  def remove_channel(channel); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#128
  def shutdown; end

  private

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#160
  def ensure_listener_running; end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#243
  def extract_subscribed_client(conn); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#204
  def reset; end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#197
  def resubscribe; end

  # @return [Boolean]
  #
  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#185
  def retry_connecting?; end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#177
...
# source://actioncable//lib/action_cable/subscription_adapter/redis.rb#215
class ActionCable::SubscriptionAdapter::Redis::Listener::SubscribedClient
  ...
  #
  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#216
  def initialize(raw_client); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#220
  def subscribe(*channel); end

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#224
  def unsubscribe(*channel); end

  private

  # source://actioncable//lib/action_cable/subscription_adapter/redis.rb#229
