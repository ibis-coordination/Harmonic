...
module Reline
  ...
  class << self
    # source://reline//reline.rb#540
    def core; end

    # source://reline//reline.rb#536
    def encoding_system_needs; end

    # source://reline//reline.rb#517
    def insert_text(*args, &block); end

    # source://reline//reline.rb#560
    def line_editor; end

    # source://reline//reline.rb#556
    def ungetc(c); end
  end
end
...
class Reline::Config
  ...
  # source://reline//reline/config.rb#264
  ...
  # source://reline//reline/config.rb#84
  def editing_mode; end

  # source://reline//reline/config.rb#88
  def editing_mode=(val); end

  # @return [Boolean]
  #
  # source://reline//reline/config.rb#92
  ...
  # source://reline//reline/config.rb#234
  ...
  # source://reline//reline/config.rb#108
  ...
  # source://reline//reline/config.rb#157
  def key_bindings; end

  # source://reline//reline/config.rb#350
  def key_notation_to_code(notation); end

  # source://reline//reline/config.rb#104
  def keymap; end
  ...
  # source://reline//reline/config.rb#384
  ...
  # source://reline//reline/config.rb#138
  def read(file = T.unsafe(nil)); end

  # source://reline//reline/config.rb#187
  def read_lines(lines, file = T.unsafe(nil)); end

  # source://reline//reline/config.rb#73
  def reset; end

  # source://reline//reline/config.rb#181
  def reset_default_key_bindings; end

  # source://reline//reline/config.rb#169
  def reset_oneshot_key_bindings; end

  # source://reline//reline/config.rb#331
  ...
  # source://reline//reline/config.rb#134
  def default_inputrc_path; end

  # @return [Boolean]
  #
  # source://reline//reline/config.rb#392
...
class Reline::Core
  ...
  #
  # source://reline//reline.rb#61
  def initialize; end

  # @raise [ArgumentError]
  #
  # source://reline//reline.rb#159
  def add_dialog_proc(name_sym, p, context = T.unsafe(nil)); end

  # source://reline//reline.rb#463
  def ambiguous_width; end

  # source://reline//reline.rb#53
  def auto_indent_proc; end

  # @raise [ArgumentError]
  #
  # source://reline//reline.rb#144
  def auto_indent_proc=(p); end

  # source://reline//reline.rb#126
  def autocompletion; end

  # source://reline//reline.rb#130
  def autocompletion=(val); end

  # source://reline//reline.rb#53
  def basic_quote_characters; end

  # source://reline//reline.rb#93
  ...
  # @raise [ArgumentError]
  #
  # source://reline//reline.rb#153
  def dig_perfect_match_proc=(p); end

  # source://reline//reline.rb#193
  def emacs_editing_mode; end

  # @return [Boolean]
  #
  # source://reline//reline.rb#202
  def emacs_editing_mode?; end
  ...
  # @raise [TypeError]
  #
  # source://reline//reline.rb#169
  def input=(val); end

  # Returns the value of attribute key_stroke.
  #
  # source://reline//reline.rb#56
  def key_stroke; end
  ...
  #
  # source://reline//reline.rb#59
  def output; end

  # @raise [TypeError]
  #
  # source://reline//reline.rb#180
  def output=(val); end
  ...
  # @raise [ArgumentError]
  #
  # source://reline//reline.rb#134
  def output_modifier_proc=(p); end

  # source://reline//reline.rb#53
  def pre_input_hook; end

  # source://reline//reline.rb#149
  ...
  # @raise [ArgumentError]
  #
  # source://reline//reline.rb#139
  def prompt_proc=(p); end

  # source://reline//reline.rb#266
  def readline(prompt = T.unsafe(nil), add_hist = T.unsafe(nil)); end

  # source://reline//reline.rb#250
...
class Reline::GeneralIO
  class << self
    ...
    # source://reline//reline/general_io.rb#101
    def deprep(otio); end
    ...
    # source://reline//reline/general_io.rb#94
    ...
    # @return [Boolean]
    #
    # source://reline//reline/general_io.rb#86
    def in_pasting?; end
    ...
    # source://reline//reline/general_io.rb#98
    def prep; end
    ...
    # source://reline//reline/general_io.rb#90
...
class Reline::LineEditor
  ...
  # source://reline//reline/line_editor.rb#639
  ...
  # source://reline//reline/line_editor.rb#1893
  def byte_pointer=(val); end

  # source://reline//reline/line_editor.rb#1657
  def call_completion_proc; end

  # source://reline//reline/line_editor.rb#1665
  ...
  # source://reline//reline/line_editor.rb#1811
  ...
  # source://reline//reline/line_editor.rb#1833
  ...
  # source://reline//reline/line_editor.rb#1275
  def editing_mode; end
  ...
  # source://reline//reline/line_editor.rb#1922
  def finish; end

  # @return [Boolean]
  #
  # source://reline//reline/line_editor.rb#1918
  def finished?; end

  # source://reline//reline/line_editor.rb#1582
  def input_key(key); end

  # source://reline//reline/line_editor.rb#1821
  def insert_text(text); end

  # source://reline//reline/line_editor.rb#973
  ...
  # source://reline//reline/line_editor.rb#1729
  ...
  # source://reline//reline/line_editor.rb#1906
  def whole_buffer; end

  # source://reline//reline/line_editor.rb#1900
  ...
  # @return [Boolean]
  #
  # source://reline//reline/line_editor.rb#1457
  def argumentable?(method_obj); end

  # source://reline//reline/line_editor.rb#2085
  def backward_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2573
  def backward_delete_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2732
  def backward_word(key); end

  # source://reline//reline/line_editor.rb#2109
  def beginning_of_line(key); end

  # source://reline//reline/line_editor.rb#1934
  ...
  # source://reline//reline/line_editor.rb#880
  def clear_dialog; end

  # source://reline//reline/line_editor.rb#886
  def clear_each_dialog(dialog); end

  # source://reline//reline/line_editor.rb#2718
  def clear_screen(key); end

  # source://reline//reline/line_editor.rb#1254
  def clear_screen_buffer(prompt, prompt_list, prompt_width); end

  # source://reline//reline/line_editor.rb#1329
  def complete(list, just_show_list = T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#1283
  def complete_internal_proc(list, is_menu); end

  # source://reline//reline/line_editor.rb#2852
  def copy_for_vi(text); end

  # source://reline//reline/line_editor.rb#2650
  def delete_char(key); end

  # source://reline//reline/line_editor.rb#2677
  ...
  # source://reline//reline/line_editor.rb#3063
  def ed_delete_next_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2981
  def ed_delete_prev_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2750
  ...
  #
  # source://reline//reline/line_editor.rb#1996
  ...
  # source://reline//reline/line_editor.rb#2741
  ...
  # source://reline//reline/line_editor.rb#3335
  ...
  #
  # source://reline//reline/line_editor.rb#2639
  def em_kill_line(key); end

  # source://reline//reline/line_editor.rb#2840
  def em_kill_region(key); end

  # source://reline//reline/line_editor.rb#2808
  def em_lower_case(key); end

  # source://reline//reline/line_editor.rb#2723
  def em_next_word(key); end

  # source://reline//reline/line_editor.rb#3330
  def em_set_mark(key); end

  # source://reline//reline/line_editor.rb#2824
  ...
  # source://reline//reline/line_editor.rb#2337
  def forward_search_history(key); end

  # source://reline//reline/line_editor.rb#2723
  def forward_word(key); end

  # source://reline//reline/line_editor.rb#2129
  ...
  # @return [Boolean]
  #
  # source://reline//reline/line_editor.rb#1461
  def inclusive?(method_obj); end

  # source://reline//reline/line_editor.rb#2245
  ...
  # source://reline//reline/line_editor.rb#1945
  ...
  # source://reline//reline/line_editor.rb#1279
  def menu(target, list); end

  # source://reline//reline/line_editor.rb#1231
  def modify_lines(before); end

  # source://reline//reline/line_editor.rb#1373
  ...
  #
  # source://reline//reline/line_editor.rb#2624
  ...
  # source://reline//reline/line_editor.rb#2862
  def vi_add(key); end

  # source://reline//reline/line_editor.rb#2976
  def vi_add_at_eol(key); end

  # source://reline//reline/line_editor.rb#3002
  def vi_change_meta(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2867
  def vi_command_mode(key); end

  # source://reline//reline/line_editor.rb#3020
  def vi_delete_meta(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2951
  def vi_delete_prev_char(key); end

  # source://reline//reline/line_editor.rb#2932
  ...
  # source://reline//reline/line_editor.rb#2893
  def vi_end_word(key, arg: T.unsafe(nil), inclusive: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#3047
  def vi_eof_maybe(key); end

  # source://reline//reline/line_editor.rb#2105
  def vi_first_print(key); end

  # source://reline//reline/line_editor.rb#3105
  def vi_histedit(key); end

  # source://reline//reline/line_editor.rb#2858
  def vi_insert(key); end

  # source://reline//reline/line_editor.rb#2971
  def vi_insert_at_bol(key); end

  # source://reline//reline/line_editor.rb#3316
  ...
  # source://reline//reline/line_editor.rb#2912
  def vi_next_big_word(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#3211
  def vi_next_char(key, arg: T.unsafe(nil), inclusive: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2873
  ...
  # source://reline//reline/line_editor.rb#3127
  def vi_paste_prev(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2922
  def vi_prev_big_word(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#3268
  def vi_prev_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2883
  def vi_prev_word(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#3183
  ...
  # source://reline//reline/line_editor.rb#3168
  def vi_to_column(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#3082
  def vi_to_history_line(key); end

  # source://reline//reline/line_editor.rb#3215
  def vi_to_next_char(key, arg: T.unsafe(nil), inclusive: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#3272
  def vi_to_prev_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#3035
  def vi_yank(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2997
  def vi_zero(key); end
...
# source://reline//reline/line_editor.rb#648
...
class Reline::LineEditor::Dialog
  ...
  # source://reline//reline/line_editor.rb#620
  def call(key); end

  # Returns the value of attribute column.
  #
  # source://reline//reline/line_editor.rb#594
  def column; end
  ...
  #
  # source://reline//reline/line_editor.rb#593
  def contents; end

  # source://reline//reline/line_editor.rb#613
  ...
  # source://reline//reline/line_editor.rb#605
  ...
  # source://reline//reline/line_editor.rb#609
  def width=(v); end
end
...
class Reline::LineEditor::DialogProcScope
  ...
  #
  # source://reline//reline/line_editor.rb#526
  def initialize(line_editor, config, proc_to_exec, context); end

  # source://reline//reline/line_editor.rb#587
  def call; end

  # source://reline//reline/line_editor.rb#542
  def call_completion_proc_with_checking_args(pre, target, post); end

  # source://reline//reline/line_editor.rb#579
  def completion_journey_data; end

  # source://reline//reline/line_editor.rb#583
  def config; end

  # source://reline//reline/line_editor.rb#534
  def context; end

  # source://reline//reline/line_editor.rb#567
  def cursor_pos; end

  # source://reline//reline/line_editor.rb#550
  def dialog; end

  # source://reline//reline/line_editor.rb#571
  def just_cursor_moving; end

  # source://reline//reline/line_editor.rb#563
  def key; end

  # source://reline//reline/line_editor.rb#538
  def retrieve_completion_block(set_completion_quote_character = T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#575
  def screen_width; end

  # source://reline//reline/line_editor.rb#554
  def set_cursor_pos(col, row); end

  # source://reline//reline/line_editor.rb#546
  def set_dialog(dialog); end

  # source://reline//reline/line_editor.rb#559
  def set_key(key); end
end
...
module Reline::Terminfo
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://reline//reline/terminfo.rb#168
    def enabled?; end
  end
end
