...
class Rack::Auth::Digest::MD5 < ::Rack::Auth::AbstractHandler
  ...
  # source://rack//lib/rack/auth/digest/md5.rb#108
  def H(data); end
...
class Rack::Cascade
  ...
  # be tried last.
  #
  # source://rack//lib/rack/cascade.rb#66
  def <<(app); end
...
class Rack::Directory
  ...
  #
  # source://rack//lib/rack/directory.rb#168
  ...
  #
  # source://rack//lib/rack/directory.rb#160
  def stat(path); end
end
...
# Stolen from Ramaze
#
# source://rack//lib/rack/directory.rb#186
...
class Rack::Files
  ...
  #
  # source://rack//lib/rack/files.rb#24
...
class Rack::Files::Iterator < ::Rack::Files::BaseIterator
  # source://rack//lib/rack/files.rb#187
  def to_path; end
end
...
class Rack::MockResponse < ::Rack::Response
  ...
  class << self
    # source://rack//lib/rack/mock.rb#204
    def [](*_arg0); end
  end
end
...
class Rack::Multipart::UploadedFile
  ...
  # source://rack//lib/rack/multipart/uploaded_file.rb#30
  def local_path; end
...
class Rack::QueryParser
  ...
  #
  # source://rack//lib/rack/query_parser.rb#56
  ...
  # source://rack//lib/rack/query_parser.rb#157
  def make_params; end

  # source://rack//lib/rack/query_parser.rb#165
  def new_depth_limit(param_depth_limit); end

  # source://rack//lib/rack/query_parser.rb#161
  ...
  #
  # source://rack//lib/rack/query_parser.rb#116
  ...
  # case.
  #
  # source://rack//lib/rack/query_parser.rb#97
  ...
  #
  # source://rack//lib/rack/query_parser.rb#69
  def parse_query(qs, d = T.unsafe(nil), &unescaper); end

  private

  # source://rack//lib/rack/query_parser.rb#187
  def check_query_string(qs, sep); end

  # @return [Boolean]
  #
  # source://rack//lib/rack/query_parser.rb#175
...
class Rack::QueryParser::Params
  ...
  # source://rack//lib/rack/query_parser.rb#214
  def [](key); end
  ...
  # @return [Boolean]
  #
  # source://rack//lib/rack/query_parser.rb#224
  def key?(key); end
  ...
  #
  # source://rack//lib/rack/query_parser.rb#246
  def to_h; end
  ...
  #      key to it is non-deterministic.
  #
  # source://rack//lib/rack/query_parser.rb#263
...
module Rack::Request::Helpers
  ...
  #
  # source://rack//lib/rack/request.rb#535
  def [](key); end
  ...
  #
  # source://rack//lib/rack/request.rb#546
  def []=(key, value); end

  # source://rack//lib/rack/request.rb#522
  def accept_encoding; end

  # source://rack//lib/rack/request.rb#526
  ...
  # source://rack//lib/rack/request.rb#505
  def base_url; end
  ...
  #
  # source://rack//lib/rack/request.rb#500
  def delete_param(k); end
  ...
  # source://rack//lib/rack/request.rb#518
  def fullpath; end
  ...
  # Note that modifications will not be persisted in the env. Use update_param or delete_param if you want to destructively modify params.
  #
  # source://rack//lib/rack/request.rb#471
  def params; end
  ...
  # source://rack//lib/rack/request.rb#514
  def path; end
  ...
  # @return [Boolean]
  #
  # source://rack//lib/rack/request.rb#530
  ...
  # <tt>env['rack.input']</tt> is not touched.
  #
  # source://rack//lib/rack/request.rb#480
  def update_param(k, v); end

  # Tries to return a remake of the original request URL as a string.
  #
  # source://rack//lib/rack/request.rb#510
  def url; end
  ...
  # like Hash#values_at
  #
  # source://rack//lib/rack/request.rb#555
  ...
  # source://rack//lib/rack/request.rb#648
  def extract_proto_header(header); end

  # source://rack//lib/rack/request.rb#639
  def forwarded_scheme; end

  # source://rack//lib/rack/request.rb#577
  ...
  # source://rack//lib/rack/request.rb#635
  ...
  #
  # source://rack//lib/rack/request.rb#564
...
class Rack::Response
  ...
  # source://rack//lib/rack/response.rb#132
  def []=(key, v); end
  ...
  #
  # source://rack//lib/rack/response.rb#30
  def header; end
...
#
# source://rack//lib/rack/sendfile.rb#117
class Rack::Sendfile
  # @return [Sendfile] a new instance of Sendfile
  #
  # source://rack//lib/rack/sendfile.rb#118
  def initialize(app, variation = T.unsafe(nil), mappings = T.unsafe(nil)); end

  # source://rack//lib/rack/sendfile.rb#126
  def call(env); end

  private

  # source://rack//lib/rack/sendfile.rb#177
  def map_accel_path(env, path); end

  # source://rack//lib/rack/sendfile.rb#161
  def variation(env); end

  # source://rack//lib/rack/sendfile.rb#167
...
class Rack::Session::Abstract::SessionHash
  ...
  # @return [Boolean]
  #
  # source://rack//lib/rack/session/abstract/id.rb#106
  def include?(key); end
  ...
  # @return [Boolean]
  #
  # source://rack//lib/rack/session/abstract/id.rb#105
  def key?(key); end
  ...
  # source://rack//lib/rack/session/abstract/id.rb#133
  def merge!(hash); end
  ...
  # source://rack//lib/rack/session/abstract/id.rb#112
...
class Rack::Session::SessionId
  ...
  #
  # source://rack//lib/rack/session/abstract/id.rb#28
  def cookie_value; end
  ...
  # Returns the value of attribute public_id.
  #
  # source://rack//lib/rack/session/abstract/id.rb#29
  def to_s; end
...
module Rack::Utils
  ...
  class << self
    ...
    #
    # source://rack//lib/rack/utils.rb#68
...
class Rack::Utils::HeaderHash < ::Hash
  ...
  # @return [Boolean]
  #
  # source://rack//lib/rack/utils.rb#497
  def member?(k); end
...
class WEBrick::HTTPResponse
  # source://rack//lib/rack/handler/webrick.rb#11
