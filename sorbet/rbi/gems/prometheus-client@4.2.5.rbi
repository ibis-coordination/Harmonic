...
#
# source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#230
class Prometheus::Client::DataStores::DirectFileStore::FileMappedDict
  # @return [FileMappedDict] a new instance of FileMappedDict
  #
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#235
  def initialize(filename, readonly = T.unsafe(nil)); end

  # Return a list of key-value pairs
  #
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#256
  def all_values; end

  # Returns the value of attribute capacity.
  #
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#233
  def capacity; end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#303
  def close; end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#288
  def increment_value(key, by); end
  ...
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#266
  ...
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#307
  def with_file_lock; end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#276
  ...
  #
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#337
  def init_value(key); end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#316
  def open_file(filename, readonly); end

  # Read position of all keys. No locking is performed.
  #
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#355
  def populate_positions; end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#332
...
class Prometheus::Client::DataStores::DirectFileStore::MetricStore
  ...
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#127
  def all_values; end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#121
  def get(labels:); end
  ...
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#194
  def aggregate_values(values); end

  # Filename for this metric's PStore (one per process)
  #
  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#181
  def filemap_filename; end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#159
  def in_process_sync; end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#171
  def internal_store; end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#190
  def process_id; end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#163
  def store_key(labels); end

  # source://prometheus-client//lib/prometheus/client/data_stores/direct_file_store.rb#186
...
#
# source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#8
class Prometheus::Client::DataStores::SingleThreaded
  # source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#11
  def for_metric(metric_name, metric_type:, metric_settings: T.unsafe(nil)); end

  private

  # source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#19
  def validate_metric_settings(metric_settings:); end
end

# source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#9
class Prometheus::Client::DataStores::SingleThreaded::InvalidStoreSettingsError < ::StandardError; end

# source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#26
class Prometheus::Client::DataStores::SingleThreaded::MetricStore
  # @return [MetricStore] a new instance of MetricStore
  #
  # source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#27
  def initialize; end

  # source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#47
  def all_values; end

  # source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#43
  def get(labels:); end

  # source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#39
  def increment(labels:, by: T.unsafe(nil)); end

  # source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#35
  def set(labels:, val:); end

  # source://prometheus-client//lib/prometheus/client/data_stores/single_threaded.rb#31
  def synchronize; end
end
...
# Pushgateway.
#
# source://prometheus-client//lib/prometheus/client/push.rb#19
class Prometheus::Client::Push
  # @raise [ArgumentError]
  # @return [Push] a new instance of Push
  #
  # source://prometheus-client//lib/prometheus/client/push.rb#31
  def initialize(job:, gateway: T.unsafe(nil), grouping_key: T.unsafe(nil), **kwargs); end

  # source://prometheus-client//lib/prometheus/client/push.rb#57
  def add(registry); end

  # source://prometheus-client//lib/prometheus/client/push.rb#52
  def basic_auth(user, password); end

  # source://prometheus-client//lib/prometheus/client/push.rb#69
  def delete; end

  # Returns the value of attribute gateway.
  #
  # source://prometheus-client//lib/prometheus/client/push.rb#29
  def gateway; end
  ...
  # source://prometheus-client//lib/prometheus/client/push.rb#63
  def replace(registry); end

  private

  # source://prometheus-client//lib/prometheus/client/push.rb#89
  def build_path(job, grouping_key); end

  # source://prometheus-client//lib/prometheus/client/push.rb#77
  def parse(url); end

  # source://prometheus-client//lib/prometheus/client/push.rb#129
  def request(req_class, registry = T.unsafe(nil)); end

  # source://prometheus-client//lib/prometheus/client/push.rb#143
  def synchronize; end

  # source://prometheus-client//lib/prometheus/client/push.rb#147
  def validate_no_basic_auth!(uri); end

  # source://prometheus-client//lib/prometheus/client/push.rb#180
  def validate_no_label_clashes!(registry); end

  # source://prometheus-client//lib/prometheus/client/push.rb#199
  def validate_response!(response); end
end

# source://prometheus-client//lib/prometheus/client/push.rb#25
Prometheus::Client::Push::DEFAULT_GATEWAY = T.let(T.unsafe(nil), String)

# source://prometheus-client//lib/prometheus/client/push.rb#22
class Prometheus::Client::Push::HttpClientError < ::Prometheus::Client::Push::HttpError; end

# source://prometheus-client//lib/prometheus/client/push.rb#20
class Prometheus::Client::Push::HttpError < ::StandardError; end

# source://prometheus-client//lib/prometheus/client/push.rb#21
class Prometheus::Client::Push::HttpRedirectError < ::Prometheus::Client::Push::HttpError; end

# source://prometheus-client//lib/prometheus/client/push.rb#23
class Prometheus::Client::Push::HttpServerError < ::Prometheus::Client::Push::HttpError; end

# source://prometheus-client//lib/prometheus/client/push.rb#26
Prometheus::Client::Push::PATH = T.let(T.unsafe(nil), String)

# source://prometheus-client//lib/prometheus/client/push.rb#27
Prometheus::Client::Push::SUPPORTED_SCHEMES = T.let(T.unsafe(nil), Array)
...
# source://prometheus-client//lib/prometheus/middleware/exporter.rb#7
