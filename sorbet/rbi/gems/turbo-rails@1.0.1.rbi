...
module Turbo::Broadcastable::ClassMethods
  def broadcast_target_default; end
  def broadcasts(inserts_by: T.unsafe(nil), target: T.unsafe(nil)); end
  def broadcasts_to(stream, inserts_by: T.unsafe(nil), target: T.unsafe(nil)); end
end
...
module Turbo::TestAssertions
  ...
  # source://turbo-rails//lib/turbo/test_assertions.rb#16
  def assert_no_turbo_stream(action:, target: T.unsafe(nil)); end

  # source://turbo-rails//lib/turbo/test_assertions.rb#10
  def assert_turbo_stream(action:, target: T.unsafe(nil), status: T.unsafe(nil), &block); end
end
