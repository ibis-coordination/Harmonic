...
class Anyway::Settings
  class << self
    ...
    #
    # source://anyway_config//lib/anyway/settings.rb#59
    def default_config_path; end

    # source://anyway_config//lib/anyway/settings.rb#61
    ...
    # @return [Boolean]
    #
    # source://anyway_config//lib/anyway/settings.rb#83
    def default_environmental_key?; end

    # source://anyway_config//lib/anyway/settings.rb#75
    def future; end
    ...
    # @return [Boolean]
    #
    # source://anyway_config//lib/anyway/settings.rb#87
    def matching_env?(env); end

    # Suppress required validations for CI/CD pipelines
    #
    # source://anyway_config//lib/anyway/settings.rb#56
    def suppress_required_validations; end

    # Suppress required validations for CI/CD pipelines
    #
    # source://anyway_config//lib/anyway/settings.rb#56
    def suppress_required_validations=(_arg0); end

    # Enable source tracing
    #
    # source://anyway_config//lib/anyway/settings.rb#73
