...
module ActionMailer::Base::HelperMethods
  ...
  # source://actionpack/7.0.8.7/lib/abstract_controller/caching.rb#43
...
module ActionMailer::MailHelper
  ...
  #
  # source://actionmailer//lib/action_mailer/mail_helper.rb#51
  def attachments; end
  ...
  #
  # source://actionmailer//lib/action_mailer/mail_helper.rb#63
  def format_paragraph(text, len = T.unsafe(nil), indent = T.unsafe(nil)); end

  # Access the mailer instance.
  #
  # source://actionmailer//lib/action_mailer/mail_helper.rb#41
  def mailer; end

  # Access the message instance.
  #
  # source://actionmailer//lib/action_mailer/mail_helper.rb#46
  def message; end
end
