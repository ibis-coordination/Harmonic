...
class Sprockets::Asset
  ...
  # @return [Boolean]
  #
  # source://sprockets//lib/sprockets/asset.rb#206
  def ==(other); end

  # Public: Returns String base64 digest of source.
  #
  # source://sprockets//lib/sprockets/asset.rb#148
  def base64digest; end

  # Public: Returns Integer length of source.
  #
  # source://sprockets//lib/sprockets/asset.rb#119
  def bytesize; end
  ...
  #
  # source://sprockets//lib/sprockets/asset.rb#111
  def charset; end

  # Public: Returns String MIME type of asset. Returns nil if type is unknown.
  #
  # source://sprockets//lib/sprockets/asset.rb#78
  def content_type; end

  # Public: Returns String byte digest of source.
  #
  # source://sprockets//lib/sprockets/asset.rb#122
  def digest; end
  ...
  # @yield [to_s]
  #
  # source://sprockets//lib/sprockets/asset.rb#164
  def each; end

  # Private: Return the version of the environment where the asset was generated.
  #
  # source://sprockets//lib/sprockets/asset.rb#127
  ...
  # @return [Boolean]
  #
  # source://sprockets//lib/sprockets/asset.rb#203
  def eql?(other); end
  ...
  # Returns String.
  #
  # source://sprockets//lib/sprockets/asset.rb#73
  ...
  #
  # source://sprockets//lib/sprockets/asset.rb#194
  def hash; end

  # Public: Returns String hexdigest of source.
  #
  # source://sprockets//lib/sprockets/asset.rb#132
  def hexdigest; end
  ...
  # Public: Returns Integer length of source.
  #
  # source://sprockets//lib/sprockets/asset.rb#116
  def length; end
  ...
  #
  # source://sprockets//lib/sprockets/asset.rb#85
  def links; end
  ...
  # Returns String.
  #
  # source://sprockets//lib/sprockets/asset.rb#92
  def source; end
  ...
  # Returns String.
  #
  # source://sprockets//lib/sprockets/asset.rb#104
  def to_s; end
  ...
  # Returns nothing.
  #
  # source://sprockets//lib/sprockets/asset.rb#173
...
#
# source://sprockets//lib/sprockets/context.rb#20
class Sprockets::Context
  # @return [Context] a new instance of Context
  #
  # source://sprockets//lib/sprockets/context.rb#41
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#200
  ...
  # @raise [NotImplementedError]
  #
  # source://sprockets//lib/sprockets/context.rb#215
  def asset_path(path, options = T.unsafe(nil)); end

  # Expand logical audio asset path.
  #
  # source://sprockets//lib/sprockets/context.rb#240
  ...
  # source file.
  #
  # source://sprockets//lib/sprockets/context.rb#127
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#143
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#152
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#39
  def environment; end
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#245
  def font_path(path); end

  # Expand logical image asset path.
  #
  # source://sprockets//lib/sprockets/context.rb#230
  def image_path(path); end

  # Expand logical javascript asset path.
  #
  # source://sprockets//lib/sprockets/context.rb#250
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#183
  ...
  # Returns Asset.
  #
  # source://sprockets//lib/sprockets/context.rb#115
  def load(uri); end
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#72
  def load_path; end
  ...
  #     # => 'application'
  #
  # source://sprockets//lib/sprockets/context.rb#80
  def logical_path; end

  # source://sprockets//lib/sprockets/context.rb#56
  def metadata; end
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#165
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#103
  ...
  # in the bundle.
  #
  # source://sprockets//lib/sprockets/context.rb#173
  def stub_asset(path); end

  # Expand logical stylesheet asset path.
  #
  # source://sprockets//lib/sprockets/context.rb#255
  def stylesheet_path(path); end

  # Expand logical video asset path.
  #
  # source://sprockets//lib/sprockets/context.rb#235
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#271
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#296
  ...
  #
  # source://sprockets//lib/sprockets/context.rb#282
  def optimize_svg_for_uri_escaping!(svg); end

  # Returns a URI-encoded data URI (always "-quoted).
  #
  # source://sprockets//lib/sprockets/context.rb#262
...
class Sprockets::Context::ENVProxy < ::SimpleDelegator
  ...
  # source://sprockets//lib/sprockets/context.rb#28
  def [](key); end

  # source://sprockets//lib/sprockets/context.rb#33
...
# Environment.
#
# source://sprockets//lib/sprockets/digest_utils.rb#10
module Sprockets::DigestUtils
  ...
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#34
  ...
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#99
  def digest(obj); end
  ...
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#16
  def digest_class; end
  ...
  # Returns a String digest of the object.
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#110
  ...
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#188
  ...
  # Returns a String or nil if hash algorithm is incompatible.
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#166
  ...
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#137
  ...
  # Returns hex String.
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#119
  ...
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#146
  ...
  #
  # source://sprockets//lib/sprockets/digest_utils.rb#128
  def unpack_hexdigest(hex); end

  private

  # source://sprockets//lib/sprockets/digest_utils.rb#193
  def build_digest(obj); end
end

# source://sprockets//lib/sprockets/digest_utils.rb#38
Sprockets::DigestUtils::ADD_VALUE_TO_DIGEST = T.let(T.unsafe(nil), Hash)

# Internal: Maps digest bytesize to the digest class.
#
# source://sprockets//lib/sprockets/digest_utils.rb#21
...
class Sprockets::Manifest
  ...
  #   age=600.
  #
  # source://sprockets//lib/sprockets/manifest.rb#245
  def clean(count = T.unsafe(nil), age = T.unsafe(nil)); end

  # Wipe directive
  #
  # source://sprockets//lib/sprockets/manifest.rb#268
  def clobber; end
  ...
  #
  # source://sprockets//lib/sprockets/manifest.rb#160
  ...
  #
  # source://sprockets//lib/sprockets/manifest.rb#138
  ...
  #
  # source://sprockets//lib/sprockets/manifest.rb#215
  def remove(filename); end

  # Persist manfiest back to FS
  #
  # source://sprockets//lib/sprockets/manifest.rb#277
  def save; end

  private

  # source://sprockets//lib/sprockets/manifest.rb#334
  def executor; end
  ...
  #
  # source://sprockets//lib/sprockets/manifest.rb#298
  def exporters_for_asset(asset); end

  # source://sprockets//lib/sprockets/manifest.rb#316
  def json_decode(obj); end

  # source://sprockets//lib/sprockets/manifest.rb#320
  def json_encode(obj); end

  # source://sprockets//lib/sprockets/manifest.rb#324
  def logger; end
end
...
module Sprockets::ProcessorUtils
  ...
  #
  # source://sprockets//lib/sprockets/processor_utils.rb#151
...
#
# source://sprockets//lib/sprockets/processor_utils.rb#125
...
#
# source://sprockets//lib/sprockets/processor_utils.rb#138
...
#
# source://sprockets//lib/sprockets/processor_utils.rb#143
...
# processor metadata.
#
# source://sprockets//lib/sprockets/processor_utils.rb#133
...
module Sprockets::Server
  ...
  #
  # source://sprockets//lib/sprockets/server.rb#139
  def bad_request_response(env); end

  # source://sprockets//lib/sprockets/server.rb#247
  def cache_headers(env, etag); end

  # Returns a CSS response that hides all elements on the page and
  # displays the exception
  #
  # source://sprockets//lib/sprockets/server.rb#187
  def css_exception_response(exception); end

  # Escape special characters for use inside a CSS content("...") string
  #
  # source://sprockets//lib/sprockets/server.rb#239
  def escape_css_content(content); end

  # @return [Boolean]
  #
  # source://sprockets//lib/sprockets/server.rb#112
  def forbidden_request?(path); end

  # Returns a 403 Forbidden response tuple
  #
  # source://sprockets//lib/sprockets/server.rb#148
  def forbidden_response(env); end

  # @return [Boolean]
  #
  # source://sprockets//lib/sprockets/server.rb#120
  def head_request?(env); end

  # source://sprockets//lib/sprockets/server.rb#268
  ...
  # source://sprockets//lib/sprockets/server.rb#165
  ...
  #
  # source://sprockets//lib/sprockets/server.rb#134
  def not_modified_response(env, etag); end

  # Returns a 200 OK response tuple
  #
  # source://sprockets//lib/sprockets/server.rb#125
  ...
  #
  # source://sprockets//lib/sprockets/server.rb#291
  def path_fingerprint(path); end

  # source://sprockets//lib/sprockets/server.rb#169
...
module Sprockets::Utils
  ...
  #
  # source://sprockets//lib/sprockets/utils.rb#157
  def dfs(initial); end
  ...
  #
  # source://sprockets//lib/sprockets/utils.rb#184
