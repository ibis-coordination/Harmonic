...
module Bootsnap
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://bootsnap//lib/bootsnap.rb#133
    def absolute_path?(path); end

    # source://bootsnap//lib/bootsnap.rb#87
    ...
    # @return [Boolean]
    #
    # source://bootsnap//lib/bootsnap.rb#80
...
module Bootsnap::CompileCache
  class << self
    ...
    #
    # source://bootsnap//lib/bootsnap/compile_cache.rb#39
    ...
    # @return [Boolean]
    #
    # source://bootsnap//lib/bootsnap/compile_cache.rb#48
    def supported?; end
  end
end
...
# source://bootsnap//lib/bootsnap/compile_cache/json.rb#63
module Bootsnap::CompileCache::JSON::Patch
  # source://bootsnap//lib/bootsnap/compile_cache/json.rb#64
...
# source://bootsnap//lib/bootsnap/compile_cache.rb#8
...
module Bootsnap::CompileCache::YAML
  class << self
    # Returns the value of attribute cache_dir.
    #
    # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#12
    def cache_dir; end

    # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#14
    def cache_dir=(cache_dir); end
    ...
    # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#83
    def patch; end

    # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#18
    def precompile(path); end

    # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#87
    def strict_load(payload); end

    # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#94
...
# source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#227
module Bootsnap::CompileCache::YAML::Psych3
  extend ::Bootsnap::CompileCache::YAML::Psych3

  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#250
  def input_to_output(data, kwargs); end

  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#230
  def input_to_storage(contents, _); end

  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#240
  def storage_to_output(data, kwargs); end
end

# source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#254
module Bootsnap::CompileCache::YAML::Psych3::Patch
  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#255
  def load_file(path, *args, **_arg2); end

  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#277
  def unsafe_load_file(path, *args, **_arg2); end
end

# source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#107
module Bootsnap::CompileCache::YAML::Psych4
  extend ::Bootsnap::CompileCache::YAML::Psych4

  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#110
  def input_to_storage(contents, _); end
end

# source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#180
...
# source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#147
module Bootsnap::CompileCache::YAML::Psych4::SafeLoad
  extend ::Bootsnap::CompileCache::YAML::Psych4::SafeLoad

  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#175
  def input_to_output(data, kwargs); end

  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#150
  def input_to_storage(contents, _); end

  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#160
  def storage_to_output(data, kwargs); end
end

# source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#118
module Bootsnap::CompileCache::YAML::Psych4::UnsafeLoad
  ...
  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#121
  def input_to_storage(contents, _); end

  # source://bootsnap//lib/bootsnap/compile_cache/yaml.rb#131
  def storage_to_output(data, kwargs); end
end
...
module Bootsnap::LoadPathCache
  class << self
    ...
    #
    # source://bootsnap//lib/bootsnap/load_path_cache.rb#25
    ...
    # @return [Boolean]
    #
    # source://bootsnap//lib/bootsnap/load_path_cache.rb#43
    def supported?; end
  end
end
...
class Bootsnap::LoadPathCache::Cache
  ...
  # source://bootsnap//lib/bootsnap/load_path_cache/cache.rb#109
  ...
  # source://bootsnap//lib/bootsnap/load_path_cache/cache.rb#103
  ...
  # source://bootsnap//lib/bootsnap/load_path_cache/cache.rb#169
  def expand_path(feature); end

  # source://bootsnap//lib/bootsnap/load_path_cache/cache.rb#208
  ...
  # source://bootsnap//lib/bootsnap/load_path_cache/cache.rb#200
  ...
  # source://bootsnap//lib/bootsnap/load_path_cache/cache.rb#236
  def try_ext(feature); end

  # source://bootsnap//lib/bootsnap/load_path_cache/cache.rb#216
  def try_index(feature); end

  # source://bootsnap//lib/bootsnap/load_path_cache/cache.rb#154
...
class Bootsnap::LoadPathCache::Path
  ...
  # of this +Path+.
  #
  # source://bootsnap//lib/bootsnap/load_path_cache/path.rb#41
  def entries_and_dirs(store); end

  # source://bootsnap//lib/bootsnap/load_path_cache/path.rb#64
  ...
  # @return [Boolean]
  #
  # source://bootsnap//lib/bootsnap/load_path_cache/path.rb#35
  def relative?; end
  ...
  # /a/b/c, pass ('/a/b', ['c'])
  #
  # source://bootsnap//lib/bootsnap/load_path_cache/path.rb#77
  def latest_mtime(path, dirs); end

  # (expensive) returns [entries, dirs]
  #
  # source://bootsnap//lib/bootsnap/load_path_cache/path.rb#70
  def scan!; end

  # source://bootsnap//lib/bootsnap/load_path_cache/path.rb#101
  def stability; end
end
...
#
# source://bootsnap//lib/bootsnap/load_path_cache/path.rb#98
...
# often.
#
# source://bootsnap//lib/bootsnap/load_path_cache/path.rb#93
Bootsnap::LoadPathCache::Path::STABLE = T.let(T.unsafe(nil), Symbol)

# source://bootsnap//lib/bootsnap/load_path_cache/path.rb#94
...
class Bootsnap::LoadPathCache::Store
  ...
  # source://bootsnap//lib/bootsnap/load_path_cache/store.rb#62
  def commit_transaction; end

  # source://bootsnap//lib/bootsnap/load_path_cache/store.rb#110
  def default_data; end

  # source://bootsnap//lib/bootsnap/load_path_cache/store.rb#91
  def dump_data; end

  # source://bootsnap//lib/bootsnap/load_path_cache/store.rb#69
  def load_data; end
end
...
# source://bootsnap//lib/bootsnap/load_path_cache/core_ext/kernel_require.rb#55
class Module
