...
import { Route as StudiosHandleDecideRouteImport } from './routes/studios/$handle/decide'
import { Route as StudiosHandleNIdRouteImport } from './routes/studios/$handle/n.$id'
import { Route as StudiosHandleDIdRouteImport } from './routes/studios/$handle/d.$id'
...
const StudiosHandleDecideRoute = StudiosHandleDecideRouteImport.update({
  id: '/decide',
  path: '/decide',
  getParentRoute: () => StudiosHandleRoute,
} as any)
...
const StudiosHandleDIdRoute = StudiosHandleDIdRouteImport.update({
  id: '/d/$id',
  path: '/d/$id',
  getParentRoute: () => StudiosHandleRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/studios/$handle/decide': typeof StudiosHandleDecideRoute
  ...
  '/studios/$handle/d/$id': typeof StudiosHandleDIdRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/studios/$handle/decide': {
      id: '/studios/$handle/decide'
      path: '/decide'
      fullPath: '/studios/$handle/decide'
      preLoaderRoute: typeof StudiosHandleDecideRouteImport
      parentRoute: typeof StudiosHandleRoute
    }
    '/studios/$handle/n/$id': {
    ...
    '/studios/$handle/d/$id': {
      id: '/studios/$handle/d/$id'
      path: '/d/$id'
      fullPath: '/studios/$handle/d/$id'
      preLoaderRoute: typeof StudiosHandleDIdRouteImport
      parentRoute: typeof StudiosHandleRoute
    }
    '/studios/$handle/cycles/today': {
...
interface StudiosHandleRouteChildren {
  StudiosHandleDecideRoute: typeof StudiosHandleDecideRoute
...
const StudiosHandleRouteChildren: StudiosHandleRouteChildren = {
  ...
  StudiosHandleDIdRoute: StudiosHandleDIdRoute,
