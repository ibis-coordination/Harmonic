Rails.application.routes.draw do
  ...
  ['collectives', 'workspace'].each do |scope_prefix|
    ...
    get "#{prefix}/pool/actions" => 'funding_pools#actions_index'
    get "#{prefix}/pool/actions/enroll_in_funding_pool" => 'funding_pools#describe_enroll_in_funding_pool'
    post "#{prefix}/pool/actions/enroll_in_funding_pool" => 'funding_pools#execute_enroll_in_funding_pool'
    get "#{prefix}/pool/actions/withdraw_from_funding_pool" => 'funding_pools#describe_withdraw_from_funding_pool'
    post "#{prefix}/pool/actions/withdraw_from_funding_pool" => 'funding_pools#execute_withdraw_from_funding_pool'
    get "#{prefix}/pool/actions/attach_funded_agent" => 'funding_pools#describe_attach_funded_agent'
    post "#{prefix}/pool/actions/attach_funded_agent" => 'funding_pools#execute_attach_funded_agent'
    get "#{prefix}/pool/actions/detach_funded_agent" => 'funding_pools#describe_detach_funded_agent'
    post "#{prefix}/pool/actions/detach_funded_agent" => 'funding_pools#execute_detach_funded_agent'
    get "#{prefix}/pool/actions/set_pool_ceiling" => 'funding_pools#describe_set_pool_ceiling'
    post "#{prefix}/pool/actions/set_pool_ceiling" => 'funding_pools#execute_set_pool_ceiling'
    post "#{prefix}/pool/create_funding_pool" => 'funding_pools#create_funding_pool'
    post "#{prefix}/pool/close_funding_pool" => 'funding_pools#close_funding_pool'
    post "#{prefix}/pool/enroll_in_funding_pool" => 'funding_pools#enroll_in_funding_pool'
    delete "#{prefix}/pool/withdraw_from_funding_pool" => 'funding_pools#withdraw_from_funding_pool'
