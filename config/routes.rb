Rails.application.routes.draw do
  ...
  ['studios','scenes'].each do |studios_or_scenes|
    ...
    get "#{studios_or_scenes}/:studio_handle/cycles/actions" => 'cycles#actions_index_default'
    get "#{studios_or_scenes}/:studio_handle/cycles/:cycle" => 'cycles#show'
    get "#{studios_or_scenes}/:studio_handle/cycle/:cycle" => 'cycles#redirect_to_show'
    get "#{studios_or_scenes}/:studio_handle/views" => 'studios#views'
    get "#{studios_or_scenes}/:studio_handle/view" => 'studios#view'
    ...
    delete "#{studios_or_scenes}/:studio_handle/represent" => 'representation_sessions#stop_representing'
    delete "#{studios_or_scenes}/:studio_handle/r/:representation_session_id" => 'representation_sessions#stop_representing'
    get "#{studios_or_scenes}/:studio_handle/representation.html" => 'representation_sessions#index_partial'
    get "#{studios_or_scenes}/:studio_handle/representation" => 'representation_sessions#index'
    ...
    post "#{studios_or_scenes}/:studio_handle/heartbeats" => 'heartbeats#create'
    get "#{studios_or_scenes}/:studio_handle/heartbeats/actions" => 'heartbeats#actions_index_default'
    post "#{studios_or_scenes}/:studio_handle/heartbeats/actions/create_heartbeat" => 'heartbeats#create_heartbeat'
  end

  ['', 'scenes/:studio_handle', 'studios/:studio_handle'].each do |prefix|
