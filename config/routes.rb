Rails.application.routes.draw do
  ...
  ['collectives', 'workspace'].each do |scope_prefix|
    ...
    get "#{prefix}/pool" => 'collectives#pool'
    get "#{prefix}/pool/actions" => 'collectives#actions_index_pool'
    get "#{prefix}/pool/actions/enroll_in_funding_pool" => 'collectives#describe_enroll_in_funding_pool'
    post "#{prefix}/pool/actions/enroll_in_funding_pool" => 'collectives#execute_enroll_in_funding_pool'
    get "#{prefix}/pool/actions/withdraw_from_funding_pool" => 'collectives#describe_withdraw_from_funding_pool'
    post "#{prefix}/pool/actions/withdraw_from_funding_pool" => 'collectives#execute_withdraw_from_funding_pool'
    post "#{prefix}/settings/create_funding_pool" => 'collectives#create_funding_pool'
    post "#{prefix}/settings/close_funding_pool" => 'collectives#close_funding_pool'
    post "#{prefix}/settings/enroll_in_funding_pool" => 'collectives#enroll_in_funding_pool'
    delete "#{prefix}/settings/withdraw_from_funding_pool" => 'collectives#withdraw_from_funding_pool'
    ...
    get "#{prefix}/settings/actions/enroll_in_funding_pool" => 'collectives#describe_enroll_in_funding_pool'
    post "#{prefix}/settings/actions/enroll_in_funding_pool" => 'collectives#execute_enroll_in_funding_pool'
    get "#{prefix}/settings/actions/withdraw_from_funding_pool" => 'collectives#describe_withdraw_from_funding_pool'
    post "#{prefix}/settings/actions/withdraw_from_funding_pool" => 'collectives#execute_withdraw_from_funding_pool'
    get "#{prefix}/settings/actions/attach_funded_agent" => 'collectives#describe_attach_funded_agent'
    post "#{prefix}/settings/actions/attach_funded_agent" => 'collectives#execute_attach_funded_agent'
    get "#{prefix}/settings/actions/detach_funded_agent" => 'collectives#describe_detach_funded_agent'
    post "#{prefix}/settings/actions/detach_funded_agent" => 'collectives#execute_detach_funded_agent'
  ...
  ['', 'collectives/:collective_handle', 'workspace/:collective_handle'].each do |prefix|
    ...
    resources :notes, only: [:show], path: "#{prefix}/n" do
      ...
      get '/actions/add_summary' => 'notes#describe_add_summary'
      post '/actions/add_summary' => 'notes#add_summary'
    ...
    resources :decisions, only: [:show], path: "#{prefix}/d" do
      ...
      get '/actions/add_summary' => 'decisions#describe_add_summary'
      post '/actions/add_summary' => 'decisions#add_summary'
    ...
    resources :commitments, only: [:show], path: "#{prefix}/c" do
      ...
      get '/actions/add_summary' => 'commitments#describe_add_summary'
      post '/actions/add_summary' => 'commitments#add_summary'
