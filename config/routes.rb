Rails.application.routes.draw do
  ...
  get 'help' => 'help#index'
  %w[privacy collectives notes reminder-notes table-notes decisions executive-decisions lottery-decisions commitments cycles search links agents automations api markdown-ui notifications representation].each do |topic|
