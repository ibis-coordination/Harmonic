...
CREATE TABLE public.api_tokens (
    ...
    token_type character varying DEFAULT 'rest'::character varying NOT NULL
);
...
--
-- Name: index_api_tokens_on_context_type_and_context_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_api_tokens_on_context_type_and_context_id ON public.api_tokens USING btree (context_type, context_id);
...
--
-- Name: index_chat_messages_on_tenant_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_chat_messages_on_tenant_id ON public.chat_messages USING btree (tenant_id);
...
--
-- Name: index_notes_on_summarizable_type_and_summarizable_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_notes_on_summarizable_type_and_summarizable_id ON public.notes USING btree (summarizable_type, summarizable_id);
...
--
-- Name: chat_messages fk_rails_c4d58352c0; Type: FK CONSTRAINT; Schema: public; Owner: -
--
