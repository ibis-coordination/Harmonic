...
They do not govern user-generated content, code identifiers (the `User#parent`
association keeps its name even though copy says "human principal"), internal comments,
or the marketing/PHILOSOPHY.md register.
...
| principal | noun | The user accountable for an agent — a human, or the collective itself for built-in agents. | parent |
...
- **owner vs. principal** — copy names the accountable user both ways (e.g. "Its owner
  can enable public writes" vs. "The principal can enable it"). One should win.
