...
class CollectiveAutomationsController < ApplicationController
  ...
  # GET /collectives/:collective_handle/settings/automations
  def index
  ...
  # GET /collectives/:collective_handle/settings/automations/:automation_id
  def show
  ...
  # GET /collectives/:collective_handle/settings/automations/:automation_id/edit
  def edit
    @page_title = "Edit #{@automation_rule.name} - #{@current_collective.name}"
  end

  # GET /collectives/:collective_handle/settings/automations/:automation_id/runs
  def runs
    @page_title = "Run History - #{@automation_rule.name}"
    @runs = @automation_rule.automation_rule_runs.recent.limit(50)
  end

  # GET /collectives/:collective_handle/settings/automations/:automation_id/runs/:run_id
  def run_show
  ...
  def describe_create
    ...
    render_action_description({
                                ...
                                resource: nil,
                                description: "Create a new collective automation rule from YAML configuration.#{tier_note}",
                                params: [
  ...
  def describe_toggle
    ...
    render_action_description({
                                ...
                                resource: @automation_rule,
                                description: "#{action.capitalize} the automation rule.#{billing_note}",
                                params: [],
                              })
  end
  ...
  def execute_toggle
    ...
    @automation_rule.update!(enabled: will_be_enabled, updated_by: @current_user)
  ...
  def default_template
    <<~YAML
      name: "New Collective Automation"
