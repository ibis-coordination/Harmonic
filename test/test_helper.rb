...
class ActiveSupport::TestCase
  ...
  # Note: This sets tenant context temporarily because subagent creation triggers
  ...
  def create_subagent(parent:, name: "Test Subagent")
    ...
    raise "Parent user must belong to a tenant to create a subagent" unless parent_tenant_user
