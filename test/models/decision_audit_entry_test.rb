...
class DecisionAuditEntryTest < ActiveSupport::TestCase
  ...
  test "ACTIONS constant contains all expected actions" do
    expected = %w[decision_created decision_updated option_added option_removed option_updated vote_cast vote_updated executive_selection decision_closed beacon_drawn]
