...
class AdminChooserControllerTest < ActionDispatch::IntegrationTest
  def setup
    ...
    @primary_superagent.add_user!(@tenant_admin)
    ...
    @primary_superagent.add_user!(@app_admin)
    ...
    @primary_superagent.add_user!(@sys_admin)
    ...
    @primary_superagent.add_user!(@multi_admin)
    ...
    @primary_superagent.add_user!(@non_admin)
  end
